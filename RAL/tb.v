...
class reg1_reg extends uvm_reg;
  ...
  covergroup g;
    ...
    coverpoint reg1.value[31:0] {
      bins lower = {[0:2147483647]};
      bins high = {[2147483648:4294967295]};
    }
  endgroup
...
class reg_block extends uvm_reg_block;
  ...
  rand reg1_reg  reg1_inst;
  rand reg2_reg  reg2_inst;
  rand reg3_reg  reg3_inst;
  rand reg4_reg  reg4_inst;
  ...
  function void build();
    ...
    default_map = create_map("default_map", 'h0, 4, UVM_LITTLE_ENDIAN,0); // name, base, nBytes
